...
If 1 Then  ; $sBat1_Orig-s-fil-nam
  ...
  Global $sBat5_Orig = $sWorkingDirSLASH & $nam[6] & $verIN & ".bat"
  Global $sBat5_Orig = $sWorkingDirSLASH & $nam[7] & $verIN & ".bat"
EndIf
...
Func Main()
	...
	CreateIncludeFromArray_ArrayAdd_All()  ;;old makeBAT() make write save:  Local $sInc1_Path = $sWorkingDirSLASH & "\bat1-" & $verOUT & ".inc"
