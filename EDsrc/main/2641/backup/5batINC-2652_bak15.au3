...
;; used nam[ :: ; $sBat1   #include "bat1-2020.inc"   $sBat1_Orig     new-nu. $sBat1_Cpy    ; --- Declare arrays to hold the file lines ---  	_CreateIncludeFromArray_ArrayAdd($aBat1_Lines, $sArr1_Name, $sInc1_Path)     Global $aBat1_Lines[1], $aBat2_Lines[1], $aBat3_Lines[1], $aBat4_Lines[1], $aBat5_Lines[1]
;
; "prj" git prj name
;~ @ECHO OFF
;~ set "prj=tst3"
