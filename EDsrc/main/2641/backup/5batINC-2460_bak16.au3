...
Func scriptAppendIncFilesCMD()
	...
	Local $sCopyList = $GlobalsArrayINC & '" + "' & $sInc1_Path & '" + "' & $sInc2_Path & '" + "' & $sInc3_Path & '" + "' & $sInc4_Path & '" + "' & $sInc5_Path & '" "' & $scriptNameAppendIncFiles & '"'
	Local $cmdToRun = @ComSpec & ' /c ' & 'copy /B "'  &     $sCopyList  
