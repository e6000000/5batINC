...
If 0 Then
	; old [11] ,  [0] is good ? do not know now
...
; used nam[ ::
; $sBat1   #include "bat1-2020.inc"   $sBat1_Orig     new-nu. $sBat1_Cpy    ; --- Declare arrays to hold the file lines ---  	_CreateIncludeFromArray_ArrayAdd($aBat1_Lines, $sArr1_Name, $sInc1_Path)     Global $aBat1_Lines[1], $aBat2_Lines[1], $aBat3_Lines[1], $aBat4_Lines[1], $aBat5_Lines[1]
...
Func SETprj($prj, ByRef $a)  ;$a[1] = 'set "prj=' & $prj & '"'
	...
	; _ArrayDisplay($a,  $a[$x])
EndFunc   ;==>SETprj
Func makeBAT()  ;_CreateIncludeFromArray_ArrayAdd($aBat1_Lines, $sArr1_Name, $sInc1_Path) ; & save
