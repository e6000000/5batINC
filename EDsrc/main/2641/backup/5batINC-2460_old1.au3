...
$sCopyList = $GlobalsArrayINC & '" + "' & $sInc1_Path & '" + "' & $sInc2_Path & '" + "' & $sInc3_Path & '" + "' & $sInc4_Path & '" + "' & $sInc5_Path & '" "' & $scriptNameAppendIncFiles & '"'
$cmdToRun = @ComSpec & ' /c ' & 'copy /B "'  &     $sCopyList
	$cmdddrun = Run($cmdToRun, "", @SW_HIDE) 
	;****************************

	
	$sCopyList = $scriptNameAppendIncFiles & '" + "' &  @ScriptFullPath & '"  "' & $5batINC_append_incs & '" '
	$cmdToRun = @ComSpec & ' /c ' & 'copy /B "'  &  $sCopyList
